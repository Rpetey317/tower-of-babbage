...
| [components/speech-engine.md](components/speech-engine.md) | Speech provider interface, Gemma 4 via llama.cpp and vLLM, prompts, mock, Gemini plan |
...
| Doc | Content |
| --- | --- |
| [deployment.md](deployment.md) | Compose services, llama-server, hardware guidance, environment |
